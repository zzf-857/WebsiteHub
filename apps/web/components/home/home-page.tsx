...
// 首页装配层（设计稿 1a 行 50–162）：左侧分类/Space 侧栏 + 右侧五个分区。
// 五个分区各自负责取数与三态 UI，这里只保管「当前分类 activeId」一个联动状态：
...
export function HomePage() {
  ...
  return (
    <div className="home-layout">
      <LibrarySidebar activeCategoryId={activeId} onSelectCategory={handleSelect} />
